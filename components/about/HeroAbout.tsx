    ...
    >
      ...
      <Container className="relative z-10 py-20 sm:py-24 lg:py-32">
        ...
        >
          ...
          >
            We architect autonomous AI systems that transform how enterprises operate.
            From intelligent workflows to production-grade agent infrastructure,
            we deliver the reliability and scale that mission-critical operations demand.
          </motion.p>
          ...
          <motion.div variants={fadeUp} className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Button variant="secondary" size="lg" href="#metrics">
              View Our Impact
            </Button>
          </motion.div>
