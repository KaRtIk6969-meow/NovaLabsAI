  ...
  return (
    <div className="relative w-full h-full min-h-[180px] flex items-center justify-center">
      <div className="relative w-[140px] h-[170px]">
        ...
        {/* Document body */}
        <motion.div
          className="absolute inset-0 rounded-lg border border-white/[0.08] bg-white/[0.03] backdrop-blur-sm overflow-hidden"
        ...
        >
          ...
          {[0, 1, 2, 3, 4, 5].map((i) => (
            <motion.div
              ...
              style={{
                top: `${20 + i * 18}px`,
                background: i < 2 ? "rgba(124,58,237,0.2)" : "rgba(255,255,255,0.06)",
                width: lineWidths[i],
              }}
        ...
        <motion.div
          className="absolute -right-6 top-8 px-2 py-1 rounded bg-white/[0.05] border border-white/[0.08] text-[8px] text-accent-cyan/70 font-mono whitespace-nowrap"
