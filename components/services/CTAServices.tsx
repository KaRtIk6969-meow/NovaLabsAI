      ...
      <Container>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            >
              Start with a free Discovery session. We&apos;ll map your AI opportunities and deliver a roadmap with projected ROI — no commitment required.
            </motion.p>
            ...
            >
              {["Free Discovery Session", "No Commitment Required", "ROI Projections Included", "24/7 Support"].map((badge) => (
